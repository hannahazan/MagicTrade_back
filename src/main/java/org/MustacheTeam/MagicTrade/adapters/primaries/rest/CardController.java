...
public class CardController {
    ...
    public CardList getCardsByFilter(
            ...
            @RequestParam(name = "foil", required = false, defaultValue = "") Boolean foil,
            @RequestParam(name = "fullArt", required = false, defaultValue = "") Boolean fullArt,
            @RequestParam(name = "textLess", required = false, defaultValue = "") Boolean textLess,
