...
public interface CardRepository {
    ...
    CardPage getAllCards(String id, String name, String setId, List<String> colors, List<String> cmc, String text, List<String> toughnesses,
                         ...
                         String pauperCommander, String duel, String oldSchool, String lastId, Integer pageSize);
